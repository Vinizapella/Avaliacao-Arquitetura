...
public class Main {
            ...
            switch (opcao) {
                case 1:
                    ...
                    if(subOp = 1) {
                        ...
                        System.out.print("Nome: "); funcNomes[funcTotal] = scanner.nextLine();
                ...
                case 2:
                    ...
                    break;
                case 3:
                    for(int i=0; i<pratoTotal; i +) System.out.println(i + ": " + pratoNomes[i] + " - R$ " + pratoPrecos[i]);
                    ...
                    break;
                case 4:
                    for(int i=0; i<pratoTotal; i +) System.out.println(i + ": " + pratoNomes[i] + " | Qtd: " + pratoEstoque[i]);
                ...
                case 5:
                    ...
                    for(int i=0; i<pratoTotal; i +)
                        System.out.println(i +": " + pratoNomes[i] + " [Estoque: " + pratoEstoque[i] + "]");
                    ...
                    if(pg = 1) {
                        ...
                        valorFinal = valorBase * 0.90;
                            ...
                            valorFinal = valorBase * 0.92;
                    }
                    pratoEstoque[esc] -= qVenda;
    ...
    private static void inicializarDados() {
        ...
        funcSalarios[0] = 8000;
        funcNomes[1] = "Ana"; funcCargos[1] = "Caixa"; funcSalarios[1] = 2000;
        funcNomes[2] = "Beto"; funcCargos[2] = "Cozinheiro";
        funcSalarios[2] = 3000;
        funcNomes[3] = "Zeca"; funcCargos[3] = "Cozinheiro";
        funcSalarios[3] = 3000;
        funcNomes[4] = "Vitor"; funcCargos[4] = "Garçom"; funcSalarios[4] = 1800;
        funcNomes[5] = "Luan"; funcCargos[5] = "Garçom"; funcSalarios[5] = 1800;
        ...
        pratoEstoque[2] = 8;
        pratoNomes[3] = "Acarajé"; pratoPrecos[3] = 25.0; pratoEstoque[3] = 15;
        ...
        pratoEstoque[8] = 6;
        pratoNomes[9] = "Tacacá"; pratoPrecos[9] = 28.0; pratoEstoque[9] = 10;
        pratoTotal = 10;
    }

    Orientações:
            1. Identifique os problemas estruturais do código: Note como o main é
    gigante e faz tudo.
            2. Comece pelas Modelos: Crie as classes Funcionario e Prato. Troque os
    vetores de Strings por um ArrayList<Funcionario> e um ArrayList<Prato>.
3. Refatore o Pagamento: Use o Anexo 2 (OCP) para criar as estratégias de
    pagamento.
4. Desacople a Venda: O método de venda não deve perguntar as coisas no
    console; ele deve receber um objeto Pedido pronto e processá-lo.
}